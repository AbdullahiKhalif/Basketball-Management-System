					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<i class="fa fa-bars fs-4 text-primary"></i> <span class="card-title fs-4">Coach Staff Report</span>
									<h6 class="card-subtitle text-muted">You can Print or export All Coach Staff statistics😍.</h6>
									<hr style="border: 1px solid #000;">
                                    <form id="coachstaffStatsReport">
                                ...
                                <img src="../../assets/img/logo.png" alt="Just Logo" class="img-fluid text-center" style="height: 150px; width:450px; margin-left: 15%; margin-bottom: 10px; margin-bottom: 10px;">
									<table id="coachstaffStatsReportTable" class="table table-striped DataTableResponsive" style="width:100%">
										<thead class="table">
...
<script src="../js/coachstaffStats.js"></script>
