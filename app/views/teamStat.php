					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<i class="fa fa-bars fs-4 text-primary"></i> <span class="card-title fs-4">Team Report</span>
									<h6 class="card-subtitle text-muted">You can Print or export All Teams statistics😍.</h6>
									<hr style="border: 1px solid #000;">
                                    <form id="teamStatsReport">
                                ...
                                <img src="../../assets/img/just-logo.png" alt="Just Logo" class="img-fluid text-center" style="height: 200px; width:650px; margin-left: 18%; margin-bottom: 10px; margin-bottom: 10px; margin-top: -40px;">
									<table id="teamStatsReportTable" class="table table-striped DataTableResponsive" style="width:100%">
										<thead class="table">
