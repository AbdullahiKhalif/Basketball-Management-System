					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<i class="fa fa-user fs-4 text-primary"></i> <span class="card-title fs-4">Players DataTables</span>
									<h6 class="card-subtitle text-muted">You can add new player, update and delete also. fill free to use our system😍.</h6>
								...
								<div class="card-body">
									<table id="playerTable" class="table table-striped DataTableResponsive" style="width:100%">
										<thead class="table">
											<tr>
												<th>#</th>
												<th>Team ID</th>
