...
$("#injuriesStatsReport").on("submit", function(event) {
    $("#injuriesStatsReportTable thead").html("");
    $("#injuriesStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getInjuriesStatement",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#injuriesStatsReportTable thead").append(th);
                 $("#injuriesStatsReportTable tbody").append(tr);
            }
        }
     })
})
