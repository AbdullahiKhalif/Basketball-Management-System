...
$("#resultStatsReport").on("submit", function(event) {
    $("#resultStatsReportTable thead").html("");
    $("#resultStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getResultStatement",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#resultStatsReportTable thead").append(th);
                 $("#resultStatsReportTable tbody").append(tr);
            }
        }
     })
})
