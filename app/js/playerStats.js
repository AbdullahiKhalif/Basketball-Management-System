...
$("#playerStatsReport").on("submit", function(event) {
    $("#playerStatsReportTable thead").html("");
    $("#playerStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getPlayerStatement",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#playerStatsReportTable thead").append(th);
                 $("#playerStatsReportTable tbody").append(tr);
            }
        }
     })
})
