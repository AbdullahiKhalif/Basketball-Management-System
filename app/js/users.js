    ...
    success: (data) => {
      ...
      if (status) {
        response.forEach((res) => {
          ...
          tr += `<td>
                    <a class="update_info" id=${res["userId"]}><i class="fa fa-edit fs-4 bg-primary text-light p-2 rounded"></i></a>
                    <a class="delete_info" id=${res["userId"]}><i class="fa fa-trash bg-danger fs-4 p-2 text-light rounded"></i></a>
                    </td>`;
          tr += "</tr>";
        });
