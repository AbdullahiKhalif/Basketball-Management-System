...
$("#coachstaffStatsReport").on("submit", function(event) {
    $("#coachstaffStatsReportTable thead").html("");
    $("#coachstaffStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getCoachingStaffSp",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#coachstaffStatsReportTable thead").append(th);
                 $("#coachstaffStatsReportTable tbody").append(tr);
            }
        }
     })
})
