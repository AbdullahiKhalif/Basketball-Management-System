...
$("#teamStandingStatsReport").on("submit", function(event) {
    $("#teamStandingStatsReportTable thead").html("");
    $("#teamStandingStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getTeamStandingSp",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#teamStandingStatsReportTable thead").append(th);
                 $("#teamStandingStatsReportTable tbody").append(tr);
            }
        }
     })
})
