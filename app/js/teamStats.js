...
$("#teamStatsReport").on("submit", function(event) {
    $("#teamStatsReportTable thead").html("");
    $("#teamStatsReportTable tbody").html("");
    event.preventDefault();
     var SendingData = {
        "action": "getTeamStatement",
     };
     ...
     $.ajax({
        ...
        success: (data) =>{
            ...
            if(status){
                 ...
                 $("#teamStatsReportTable thead").append(th);
                 $("#teamStatsReportTable tbody").append(tr);
            }
        }
     })
})
